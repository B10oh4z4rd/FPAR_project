...
from selfSupervisedObjectAttentionModelConvLSTM import *
...
class twoStreamAttentionModel(nn.Module):
    ...
    def forward(self, inputVariableFlow, inputVariableFrame):
        ...
        _, rgbFeats, mapPrediction = self.frameModel(inputVariableFrame)
        twoStreamFeats = torch.cat((flowFeats, rgbFeats), 1)
        return self.classifier(twoStreamFeats), mapPrediction